...
public class LoginController implements LoginApi {
    ...
    public Mono<ResponseEntity<LoginResponse>> login(final ServerWebExchange exchange) {
        ...
        return ReactiveSecurityContextHolder.getContext().mapNotNull(SecurityContext::getAuthentication).mapNotNull(Authentication::getPrincipal).map(Jwt.class::cast).flatMap(principal -> {
